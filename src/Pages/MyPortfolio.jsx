    ...
    <section className="portfolio--section" id="MyPortfolio">
      ...
      <div className="portfolio--section--container">
        ...
        >
          ...
          <div className="portfolio--section--card--content">
            <div>
              <h3 className="portfolio--section--title">Super Market | Django </h3>
              <p className="text-md">
              "Super Mart" is an e-commerce web application built using Django, MySQL, HTML, CSS, Bootstrap, JavaScript, and Python.
              <br />It features Admin, Customer, Product, and Order Management with full CRUD functionality.
              <br />Django’s built-in authentication system is used for secure admin login and access control.
              <br />Data is efficiently handled through Django-MySQL integration for real-time access and updates.
              </p>
            </div>
        ...
        >
          ...
          <div className="portfolio--section--card--content">
            <div>
              <h3 className="portfolio--section--title">Calculator | Html, Css, JS</h3>
              <p className="text-md">
        ...
        >
          ...
          <div className="portfolio--section--card--content">
            <div>
              <h3 className="portfolio--section--title">Amazon Website | React Js</h3>
              <p className="text-md">
      ...
      <div className="portfolio--section--container">
        ...
        >
          ...
          <div className="portfolio--section--card--content">
            <div>
              <h3 className="portfolio--section--title">Cisco Website | Html, Css, JS</h3>
              <p className="text-md">
        ...
        >
          ...
          <div className="portfolio--section--card--content">
            <div>
              <h3 className="portfolio--section--title">Bus Booking System | Pyhton</h3>
              <p className="text-md">
        ...
        >
          ...
          <div className="portfolio--section--card--content">
            <div>
              <h3 className="portfolio--section--title">Banking System | Python</h3>
              <p className="text-md">
